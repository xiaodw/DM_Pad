...
UIKIT_EXTERN NSString * const Logout_Msg;
...
UIKIT_EXTERN NSString * const DMTitleVedio;
...
UIKIT_EXTERN NSString * const DMTitleSelfHome;
UIKIT_EXTERN NSString * const DMTitleCourseList;
UIKIT_EXTERN NSString * const DMTitleCustomerService;
...
UIKIT_EXTERN NSString * const DMAlertTitleVedioError;
