...
NSString * const DMTitleCloseSync = @"请问您确定要结束同步吗?";
NSString * const DMTitleCloseSyncMessage = @"确定后同步将关闭";
NSString * const DMTitleDeletedPhotos = @"您确定要删除这些张图片吗?";
NSString * const DMTitleDeletedPhotosMessage = @"确定后关闭编辑状态";
NSString * const DMTitleDeletedPhoto = @"您确定要删除这张图片吗?";
NSString * const DMTitleDeletedPhotoMessage = @"确定后预览自动关闭";
NSString * const DMTitleUploadFail = @"有图片上传失败, 是否重新上传";
NSString * const DMTitleUploadFailMessage = @"点击是后继续上传失败的图片";
NSString * const DMTitleVedio = @"这里设置视频标题";
...
NSString * const DMTitlePhotoUploadCount = @"传送(%zd)";
...
NSString * const DMTitleSelfHome = @"首页";
NSString * const DMTitleCourseList = @"课程列表";
NSString * const DMTitleCustomerService = @"联系客服";
...
NSString * const DMTextLiveDelayTime = @"本课堂将于%zd分钟后自动关闭";
NSString * const DMTextLiveStartTimeInterval = @"距离上课时间还有%zd分钟";
